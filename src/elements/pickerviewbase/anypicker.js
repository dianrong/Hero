...
AnyPicker.prototype = {
	...
	init: function()
	{
		...
		if($.CF.isValid(apo.setting.inputElement))
		{
			...
			if(apo.tmp.sInputElemTag === "input" || apo.tmp.sInputElemTag === "paper-input")
	...
	_showPicker: function()
	{
		...
		sTemp += "<div_anypicker class='ap-overlay " + sLayout + " " + apo.tmp.overlayClass + " " + sTheme + " " + sDir + "'>";
	...
	_adjustOnOrientationChange: function()
	{
		...
		{
			$("body").prepend("<div_anypicker class='ap-loading'>Loading</div_anypicker>");
...
AnyPicker.prototype = $.extend(AnyPicker.prototype, {
	...
	reloadComponent: function(iComp, bSingleLoad)
	{
		...
		if($oeComp.length === 0)
			sTemp += "<div_anypicker class='ap-component' id='" + sCompId + "' data-type='" + sType + "' " + (sWidth !== "" ? ("style='" + sWidth + ";'") : "") + ">";

		if(!$.CF.compareStrings(apo.setting.theme, "Windows"))
		{
			if(apo.setting.showComponentLabel)
				sTemp += "<div_anypicker class='ap-component-label' " + (sTextAlign !== "" ? ("style='" + sTextAlign + ";'") : "") + ">" + oComp.label + "</div_anypicker>";
		}

		if($.CF.compareStrings(apo.setting.rowsNavigation, "scroller+buttons") || $.CF.compareStrings(apo.setting.rowsNavigation, "buttons"))
			sTemp += "<div_anypicker class='ap-component-plus ap-icon-arrow-up-filled' " + (sTextAlign !== "" ? ("style='" + sTextAlign + ";'") : "") + "></div_anypicker>";

		sTemp += "<div_anypicker class='ap-component-cont' tabindex='0'>";

		sTemp += "<div_anypicker class='ap-component-data' role='listbox' aria-label='" + oComp.label + "'>";
		...
		for(iRowIndex = 0; iRowIndex < oSData.length; iRowIndex++)
		{
			...
			sTemp += "<div_anypicker class='ap-row " + sClassSelectedRow + "' id='ap-row-" + iComp + "-" + iRowIndex+ "' data-value='" + oSData[iRowIndex].val + "' data-label='" + oSData[iRowIndex].label + "' role='option' aria-selected='" + bIsSelected + "' " + (sTextAlign !== "" ? ("style='" + sTextAlign + ";'") : "") + ">";
		...
		sTemp += "<div_anypicker class='ap-component-selector' id='ap-component-selector-" + iComp + "'></div_anypicker>";

		sTemp += "</div_anypicker>";

		if($.CF.compareStrings(apo.setting.rowsNavigation, "scroller+buttons") || $.CF.compareStrings(apo.setting.rowsNavigation, "buttons"))
			sTemp += "<div_anypicker class='ap-component-minus ap-icon-arrow-down-filled' " + (sTextAlign !== "" ? ("style='" + sTextAlign + ";'") : "") + "></div_anypicker>";
